...
abstract class HardwareComponent {
    ...
    // ABSTRAKTNÍ METODA: Nutíme každého potomka, aby definoval, jak se popíše.
...
class Cart {
    ...
    public getItems(): HardwareComponent[] { return this.items.slice(); } // Vracíme kopii pole, aby někdo omylem neměnil originál
...
class PCShop {
    ...
    public start(): void {
        ...
        // TOVÁRNÍ VZOR (Factory): Převádíme "hloupá" data z JSONu na "inteligentní" objekty
